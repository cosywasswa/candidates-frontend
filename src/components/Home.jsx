...
const Home = () => {
  ...
  const filteredCandidates = candidatesArr.filter((candidate)=>candidate.tier.toString().includes(searchTier))
  ...
  <div className="pt-5">
    <input type="text" placeholder="search by tier" className="outline-none bg-white rounded-2xl px-2 relative left-44 top-5 w-60"
    value={searchTier}
  ...
  {filteredCandidates.length > 0 ? (
    ...
    <p className="text-gray-500 mt-4">No candidates found for this tier.</p>
  )}
</section>
</main>
